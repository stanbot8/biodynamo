...
SET(ROOT_BLD_SCRIPT_LOCATION "${CMAKE_SOURCE_DIR}/util/build-third-party")
...
if(EXISTS "${CMAKE_SOURCE_DIR}/third_party/root")
 ...
 execute_process(COMMAND bash ${ROOT_BLD_SCRIPT_LOCATION}/build-root_new.sh ${CMAKE_SOURCE_DIR} RESULT_VARIABLE ROOT_DOWNLOAD_OR_BUILD)
 message(VALUE="${ROOT_DOWNLOAD_OR_BUILD}")
 message(VALUE="${ROOT_SOURCE_DIR}")
 if(${ROOT_DOWNLOAD_OR_BUILD} EQUAL 1)
 ...
 if(${ROOT_DOWNLOAD_OR_BUILD} EQUAL 0)
   file(MAKE_DIRECTORY "${CMAKE_SOURCE_DIR}/build/third_party")
   file(COPY "${CMAKE_SOURCE_DIR}/third_party/root" DESTINATION "${CMAKE_SOURCE_DIR}/build/third_party")
 endif()
endif()
