...
# Default: ROOT 6.38.02 from https://root.cern/download/
set(ROOT_VERSION "6.38.02")
set(ROOT_DOWNLOAD_URL "https://root.cern/download")
...
if(APPLE)
  if("${DETECTED_OS_VERS}" MATCHES "^osx-15" OR
    ...
    # Xcode 16.x: use LFS builds (CERN pre-built binaries have PCM/modulemap
    # incompatibilities across SDK versions, so we use per-Xcode LFS builds)
    if("${XCODE_VERS}" GREATER_EQUAL "16.4")
      message(STATUS "##### Using ROOT builds for XCODE 16.4 (LFS)")
      ...
      set(ROOT_DOWNLOAD_URL "http://cern.ch/biodynamo-lfs/third-party")
    elseif("${XCODE_VERS}" GREATER_EQUAL "16.3")
      message(STATUS "##### Using ROOT builds for XCODE 16.3 (LFS)")
    ...
    elseif("${XCODE_VERS}" GREATER_EQUAL "16.2")
      message(STATUS "##### Using ROOT builds for XCODE 16.2 (LFS)")
    ...
    elseif("${XCODE_VERS}" GREATER_EQUAL "16.1")
      message(STATUS "##### Using ROOT builds for XCODE 16.1 (LFS)")
    ...
    elseif("${XCODE_VERS}" GREATER_EQUAL "16.0")
      message(STATUS "##### Using ROOT builds for XCODE 16.0 (LFS)")
      ...
      set(ROOT_DOWNLOAD_URL "http://cern.ch/biodynamo-lfs/third-party")
    # Xcode 15.x: fall back to older ROOT from LFS
    elseif("${XCODE_VERS}" GREATER_EQUAL "15.4")
      message(STATUS "##### Using ROOT builds for XCODE 15.4 (LFS fallback)")
    ...
    elseif("${XCODE_VERS}" GREATER_EQUAL "15.3")
      message(STATUS "##### Using ROOT builds for XCODE 15.3 (LFS fallback)")
    ...
    elseif("${XCODE_VERS}" GREATER_EQUAL "15.0")
      message(STATUS "##### Using ROOT builds for XCODE 15.2 (LFS fallback)")
    ...
    elseif("${XCODE_VERS}" GREATER_EQUAL "14.3")
      message(STATUS "##### Using ROOT builds for XCODE 14.3 (LFS fallback)")
    ...
    elseif("${XCODE_VERS}" GREATER_EQUAL "14.2")
      message(STATUS "##### Using ROOT builds for XCODE 14.2 (LFS fallback)")
    ...
    elseif("${XCODE_VERS}" GREATER_EQUAL "14.1")
      message(STATUS "##### Using ROOT builds for XCODE 14.1 (LFS fallback)")
      ...
      message(STATUS "##### Using ROOT builds for XCODE 13.1 (LFS fallback)")
...
elseif("${DETECTED_OS_VERS}" MATCHES "^ubuntu-24")
  set(ROOT_TAR_FILE root_v${ROOT_VERSION}.Linux-ubuntu24.04-x86_64-gcc13.3.tar.gz)
  set(ROOT_SHA_KEY ubuntu-24.04-ROOT)
elseif("${DETECTED_OS_VERS}" MATCHES "^ubuntu-22")
  set(ROOT_TAR_FILE root_v${ROOT_VERSION}.Linux-ubuntu22.04-x86_64-gcc11.4.tar.gz)
  set(ROOT_SHA_KEY ubuntu-22.04-ROOT)
elseif("${DETECTED_OS_VERS}" MATCHES "^ubuntu-20")
  # Fall back to 6.30.02 from LFS
  set(ROOT_TAR_FILE root_v6.30.02_cxx17_python3.9_${DETECTED_OS_VERS}.tar.gz)
  set(ROOT_DOWNLOAD_URL "http://cern.ch/biodynamo-lfs/third-party")
elseif("${DETECTED_OS_VERS}" MATCHES "^ubuntu-18")
  set(ROOT_TAR_FILE root_v6.30.02_cxx17_python3.9_${DETECTED_OS_VERS}.tar.gz)
  set(ROOT_DOWNLOAD_URL "http://cern.ch/biodynamo-lfs/third-party")
elseif("${DETECTED_OS_VERS}" MATCHES "^centos-7")
  set(ROOT_TAR_FILE root_v6.30.02_cxx17_python3.9_${DETECTED_OS_VERS}.tar.gz)
  set(ROOT_DOWNLOAD_URL "http://cern.ch/biodynamo-lfs/third-party")
else()
  message(FATAL_ERROR "No pre-built ROOT binary for ${DETECTED_OS_VERS}. "
    "Check https://root.cern/install/all_releases/ for available binaries.")
endif()
...
download_verify_extract(
  ${ROOT_DOWNLOAD_URL}/${ROOT_TAR_FILE}
  ${ROOT_SOURCE_DIR}
  ${ROOT_SHA}
)
