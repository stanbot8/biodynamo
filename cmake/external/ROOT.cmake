...
if(APPLE)
  if("${DETECTED_OS_VERS}" MATCHES "^osx-15" OR
    ...
    # Xcode 16+: use ROOT 6.38.02 from root.cern (keyed by arch)
    if("${XCODE_VERS}" GREATER_EQUAL "16.0")
      if("${DETECTED_ARCH}" STREQUAL "arm64")
        set(ROOT_TAR_FILE root_v${ROOT_VERSION}.macos-15.7-arm64-clang170.tar.gz)
        set(ROOT_SHA_KEY osx-15-arm64-ROOT)
      else()
        set(ROOT_TAR_FILE root_v${ROOT_VERSION}.macos-14.8-x86_64-clang160.tar.gz)
        set(ROOT_SHA_KEY osx-14-i386-ROOT)
      endif()
